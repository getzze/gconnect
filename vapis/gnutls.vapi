...
//	}
	...
	namespace X509
	{
		...
		public class Certificate
		{
			...
			public int set_extension_by_oid (string oid, char[] buf, bool critical);

            [CCode (cname = "gnutls_x509_crt_set_dn_by_oid")]
            private int _set_dn_by_oid (string oid, uint raw_flag, [CCode (array_length_type = "uint")] uint8[] name);
            [CCode (cname = "gnutls_x509_crt_set_dn_by_oid_string")]
            public int set_dn_by_oid (string oid, uint raw_flag, string name) {
                return _set_dn_by_oid (oid, raw_flag, name.data);
            }
		...
		public class PrivateKey
		{
			...
			public int export (CertificateFormat format, [CCode (array_length = false)] ref uint8[] output, ref size_t output_size);
