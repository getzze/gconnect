...
//	}
	...
	[CCode (cheader_filename = "gnutls/x509.h", cprefix = "GNUTLS_KP_")]
	namespace KP
	{
		// Key purpose Object Identifiers.

		public const string TLS_WWW_SERVER;
		public const string TLS_WWW_CLIENT;
		public const string CODE_SIGNING;
		public const string EMAIL_PROTECTION;
		public const string TIME_STAMPING;
		public const string OCSP_SIGNING;
	...
	namespace X509
	{
		...
		public class Certificate
		{
            ...
            public int set_string_issuer_dn_by_oid (string oid, uint raw_flag, string name) {
                return set_issuer_dn_by_oid (oid, raw_flag, name.data, name.length);
            }
